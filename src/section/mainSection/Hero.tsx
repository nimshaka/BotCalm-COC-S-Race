  ...
  return (
    <section id="home">
      <div className="bg-gradient-to-r from-[#1D2801] via-[#324503] to-[#1D2801] ">
        <div className="flex flex-col items-center justify-between w-full mx-auto max-w-[1920px]">
          ...
          <div className="flex flex-row items-center justify-center w-full  2xl:mt-[118px]  gap-x-16 lg:mt-3 ">
            ...
            <div className="flex flex-col items-center 2xl:-mt-16 md:mt-10">
              ...
              <div className="flex items-center justify-center w-full">
                <button className="text-[#FDF4DC] transition-transform transform hover:scale-110 bg-[#EB2D26] border-[#151D00] rounded-full h-[57px] w-[190px] font-CaesarDressingRegular text-[20px] border-4 2xl:h-[67px] 2xl:w-[207px]">
                  START RACE
                </button>
              </div>
