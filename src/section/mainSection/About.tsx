...
export default function About() {
  return (
    <div className="bg-gradient-to-r from-[#1D2801] via-[#324503] to-[#1D2801] mx-auto max-w-[1920px] flex-col">
      <div className="flex flex-col items-center justify-center w-full mt-0 -translate-y-32 md:flex-row md:-translate-y-0">
        {/* About */}
      ...
      {/* Coc section */}
      <div className="flex flex-col -translate-y-40 border md:-translate-y-0 md:mt-[100px] items-center md:items-start">
        {/* Text */}
        <div className="flex border md:ml-[100px] font-CaesarDressingRegular">
          <h2 className="2xl:text-[64px] xl:text-[60px] lg:text-[50px] md:text-[45px] text-[#FDF4DC] drop-shadow-[4px_4px_0px_#000000] text-[40px]">
            Creater your own{" "}
            <span className="ml-2 text-lime-400 drop-shadow-[4px_4px_0px_#000000]">
              COQ
            </span>
          </h2>
        </div>
        ...
        {/* <CardSlider /> */} <div>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur?"
