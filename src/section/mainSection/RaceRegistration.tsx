...
import Track from "../../assets/images/racing_track2.webp";
...
export default function RaceRegistration() {
  useEffect(() => {
    gsap.to(".car1", {
      x: "200%", // Increased distance
      ease: "linear",
      duration: 5, // Slower movement
      repeat: -1,
      yoyo: true, // Makes the car move back and forth smoothly
    });
  }, []);

  useEffect(() => {
    gsap.to(".car2", {
      x: "180%", // Increased distance
      ease: "linear",
      duration: 6, // Different duration for variation
      repeat: -1,
      yoyo: true, // Makes the car move back and forth smoothly
    });
  }, []);
        ...
        <div className="flex flex-col w-full mt-[50px]  md:flex-row 2xl:mt-[220px] md:mt-[120px]">
            ...
            <div>
              <div className="flex justify-center font-CaesarDressingRegular mt-[49px] 2xl:mt-[9px]">
                <div className="flex items-center rounded-full border border-[#FDF4DC] w-[358px] h-[76px]  md:justify-between 2xl:w-[655px] 2xl:h-[86px]">
                  ...
                  />
                  <button className="text-[#FDF4DC] transition-colors bg-[#EB2D26] border-[#151D00] rounded-full w-[87px] h-[58px] mr-1 border-4 2xl:w-[207px] 2xl:h-[67px] text-[16px] md:text-[20px] hover:scale-90">
                    BUY
                  </button>
                </div>
              </div>
          ...
          <div className="flex items-center justify-center lg:items-start">
            ...
            <img
              src={Map2}
              alt="Map2"
              className="hidden md:block 2xl:w-[670px] 2xl:h-[408px] lg:-translate-x-10 md:-translate-x-5 md:-mt-0"
            />
          </div>
          {/* Image2 */}
        </div>
          ...
          <div className="flex flex-col items-center justify-center w-full h-auto -translate-y-40 2xl:-translate-y-24 lg:-translate-y-16 md:-translate-y-10">
            ...
            <div className="relative w-full">
              <img
                src={Track}
                alt="Racing Track"
                className="relative hidden w-full sm:flex racing-track"
              />

              <img
                src={Track2}
                alt="Racing Track"
                className="relative flex w-full sm:hidden racing-track"
              />
              <img
                src={Car1}
                alt="Car 1"
                className="absolute car1 hidden sm:flex -rotate-2 
                   w-[40%] md:w-[40%] lg:w-[35%] xl:w-[32%] 
                  md:top-10 sm:top-6 xl:top-24 2xl:top-32" 
              />

              {/* Car 2 - Responsive Image */}
              <img
                src={Car2}
                alt="Car 2"
                className="absolute car2 hidden sm:flex -rotate-2 
                 w-[40%] md:w-[45%] lg:w-[40%] xl:w-[35%] sm:top-28
                   md:top-36 xl:top-64 2xl:top-96" 
              />
